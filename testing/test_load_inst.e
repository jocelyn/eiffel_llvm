...
feature -- Test routines
	...
	test_load_inst_1
		...
		do
			...
			create i1.make_index (g, create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 0))
			create i2.make (i1)
...
@0 = constant [1 x i32] [i32 8]                   ; <[1 x i32]*> [#uses=1]

define i32 @main() {
  %1 = getelementptr [1 x i32]* @0, i32 0         ; <[1 x i32]*> [#uses=1]
  %2 = load [1 x i32]* %1                         ; <[1 x i32]> [#uses=0]
}
