...
feature -- Test routines
	...
	test_memory
		...
		do
			...
			create g1.make_index (mem, create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 0))
			create g2.make_index (mem, create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 0))
			create l1.make (g1)
			create l2.make (g2)
...
define i32 @main() {
  ...
  %2 = getelementptr i32* %1, i32 0               ; <i32*> [#uses=1]
  %3 = getelementptr i32* %1, i32 0               ; <i32*> [#uses=1]
  %4 = load i32* %2                               ; <i32> [#uses=1]
  %5 = load i32* %3                               ; <i32> [#uses=1]
  %6 = add i32 %4, %5                             ; <i32> [#uses=0]
}
