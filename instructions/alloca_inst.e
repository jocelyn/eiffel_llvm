...
feature {NONE} -- Externals
	...
	make_type_array_align_name_external (ty: POINTER; array_size: POINTER; align: NATURAL_32; name: POINTER): POINTER
		...
		alias
			"[
				return new llvm::AllocaInst ((const llvm::Type *)$ty, (llvm::Value *)$array_size, $align, *((llvm::Twine *)$name));
			]"
		end
	...
	make_type_array_align_external (ty: POINTER; array_size: POINTER; align: NATURAL_32): POINTER
		...
		alias
			"[
				return new llvm::AllocaInst ((const llvm::Type *)$ty, (llvm::Value *)$array_size, $align);
			]"
		end
	...
	make_type_array_name_external (ty: POINTER; array_size: POINTER; name: POINTER): POINTER
		...
		alias
			"[
				return new llvm::AllocaInst ((const llvm::Type *)$ty, (llvm::Value *)$array_size, *((llvm::Twine *)$name));
			]"
		end
	...
	make_type_array_external (ty: POINTER; array_size: POINTER): POINTER
		...
		alias
			"[
				return new llvm::AllocaInst ((const llvm::Type *)$ty, (llvm::Value *)$array_size);
			]"
		end
	...
	make_type_external (ty: POINTER): POINTER
		...
		alias
			"[
				return new llvm::AllocaInst ((const llvm::Type *)$ty);
			]"
		end
	...
	make_type_name_external (ty: POINTER; name: POINTER): POINTER
		...
		alias
			"[
				return new llvm::AllocaInst ((const llvm::Type *)$ty, *((llvm::Twine *)$name));
			]"
		end
